            ...
            <div class="card">
                ...
                <div class="tab-content ">
                    <div class="tab-pane active" id="tab1">
                     <form class="form-signin" id="frm-personal-information" name="add_name" id="add_name" method="post" action="update/updatepersonal.php">
...
<div class="row">
    <div class="col-xs-12">
        <div class="text-right">
            <a href="#zxc" id="zxc"></a><button type="submit" class="btn btn-default next-tab">Save and Next</button>
        </div>
    </div>
</div>
</form>
...
<div class="tab-pane" id="tab2">
    ...
    <tr>
      ...
      <td width="43%"><input type="text" name="sfirstname" value="{{ $empDetails[0]->sFirstname }}" class="form-control " ></td>
...
<tr>
    ...
    <td colspan="2"> <input type="text" name="occupation" value="{{ $empDetails[0]->sOccupation }}" class="form-control " ></td>
</tr>
<tr>
    <th scope="row" class="col-lg-3">
        <label for="">EMPLOYER/BUSINESS NAME:</label>
    </th>
    <td colspan="2"><input type="text" name="businessname" value="{{ $empDetails[0]->sBusinessname }}" class="form-control " ></td>
</tr>
<tr>
    <th scope="row" class="col-lg-3">
       <label for="">BUSINESS ADDRESS:</label>
   </th>
   <td colspan="2"><input type="text" name="businessaddress" value="{{ $empDetails[0]->sBusinessaddress }}" class="form-control " ></td>
</tr>
<tr>
    <th scope="row" class="col-lg-3">
        <label for="">TELEPHONE NO.:</label>
...
<td colspan="2"><input type="text" id="stel" name="stelno" onkeyup="meme()" value="{{ $empDetails[0]->sTel }}" class="form-control" >  </td>
</tr>
<tr>
    <th scope="row" class="col-lg-3">
...
<table class='table table-striped table-hover' >
    ...
    <tr >
       <th class='success  col-lg-5 '>Name of Children</th>
       <th class='success  col-lg-5 '>Date of Birth</th>
       <th colspan=2 class='success  col-lg-4 text-right'>Action</th>    
   </tr>
